# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 15:25:55 2020
...
2. Import data
3. Inspect data and check null values
"""
...
## Import data
country = pd.read_csv('../Data Science/Kaggle/GlobalLandTemperaturesByCountry.csv')
city = pd.read_csv('../Data Science/Kaggle/GlobalLandTemperaturesByCity.csv')
country_code = pd.DataFrame(pd.read_csv('../Data Science/ISO.csv'))
